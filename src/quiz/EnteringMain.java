...
//		이미지
		MainPanel inputpanel = new MainPanel(new ImageIcon(".\\src\\images\\inputquiz1.png").getImage());
...
//		비밀번호
		...
		inputpanel.add(quizPasswordField);
...
//		크기조정
	...
	public static void main(String[] args) {
		EnteringMain ent = new EnteringMain();
	}
